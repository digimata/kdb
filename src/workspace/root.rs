...
//!
//! A kdb workspace is identified by a `.kdb/` marker directory at its root. This
...
// -----------------------------
// projects/kdb/src/workspace/root.rs
//
...
/// Marker directory that identifies the root of a kdb workspace.
...
/// the canonical path to the workspace root, or an error if no marker is found.
